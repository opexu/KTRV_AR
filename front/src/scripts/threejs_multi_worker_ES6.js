...
function isMobile () {
  ...
  export function start(markerUrls, video, input_width, input_height, targetCanvas, render_update, track_update, ) {
    var vw, vh;
    var sw, sh;
    var pscale, sscale;
    var w, h;
    ...
    var load = function () {
      ...
      worker = new Worker('./../src/scripts/artoolkitNFT_multi_ES6.worker.js')
